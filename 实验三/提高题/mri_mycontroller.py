...
def applyswid(p4info_helper, ingress_sw, egress_sw, swid):
    table_entry = p4info_helper.buildTableEntry(
    ...
    print("Swid has been set to %s" % ingress_sw.name)
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        applyswid(p4info_helper, s1, s1, 1)
        applyswid(p4info_helper, s2, s2, 2)
        applyswid(p4info_helper, s3, s3, 3)
