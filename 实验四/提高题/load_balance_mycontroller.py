...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        matchHashValue(p4info_helper, swIngress=s1, swEgress=s1, ecmp_select=0, nhop_dmac="00:00:00:00:01:02", nhop_ipv4="10.0.2.2", port=2)
        matchHashValue(p4info_helper, swIngress=s1, swEgress=s1, ecmp_select=1, nhop_dmac="00:00:00:00:01:03", nhop_ipv4="10.0.3.3", port=3)
        ...
        matchHashValue(p4info_helper, swIngress=s2, swEgress=s2, ecmp_select=0, nhop_dmac="00:00:00:00:02:02", nhop_ipv4="10.0.2.2", port=1)
        ...
        matchHashValue(p4info_helper, swIngress=s3, swEgress=s3, ecmp_select=0, nhop_dmac="00:00:00:00:03:03", nhop_ipv4="10.0.3.3", port=1)
